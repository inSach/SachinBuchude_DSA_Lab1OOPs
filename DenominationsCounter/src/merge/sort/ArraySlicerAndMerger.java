...
public class ArraySlicerAndMerger {
	...
	private void compareAndMerge(int startIndex,
		...
		while (leftSubArrayPointer <= midPointIndex && rightSubArrayPointer <= endIndex) {
		...
		for (leftSubArrayPointer = startIndex; leftSubArrayPointer <= endIndex; leftSubArrayPointer ++) {
